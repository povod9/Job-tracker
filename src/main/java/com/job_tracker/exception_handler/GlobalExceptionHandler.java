...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ExceptionDto> handleNotFoundException(EntityNotFoundException e) {
    ExceptionDto exceptionDto = new ExceptionDto("Not Found", e.getMessage(), OffsetDateTime.now());
  ...
  public ResponseEntity<ExceptionDto> handleInvalidCredentialsException(
    ...
    ExceptionDto exceptionDto =
        new ExceptionDto("Invalid Credentials", e.getMessage(), OffsetDateTime.now());
  ...
  public ResponseEntity<ExceptionDto> handleIllegalArgumentException(IllegalArgumentException e) {
    ExceptionDto exceptionDto =
        new ExceptionDto("Illegal Argument", e.getMessage(), OffsetDateTime.now());
  ...
  public ResponseEntity<ExceptionDto> handleAccessDeniedException(AccessDeniedException e) {
    ExceptionDto exceptionDto =
        new ExceptionDto("Access Denied", e.getMessage(), OffsetDateTime.now());
  ...
  public ResponseEntity<ExceptionDto> handleInvalidApplicationStatusTransition(
    ...
    ExceptionDto exceptionDto =
        new ExceptionDto("Invalid Application Status", e.getMessage(), OffsetDateTime.now());
