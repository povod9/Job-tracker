...
// public class ExecutionTimeBeanPostProcessor implements BeanPostProcessor {
//     @Override
//     public @Nullable Object postProcessBeforeInitialization(Object bean, String beanName) throws
// BeansException {
//
...
//         var methodsWithAnnotation = Arrays.stream(methods)
...
//             return bean;
//         }else {
//             var mapAnnotation = methodsWithAnnotation.stream()
//                     .collect(Collectors.toMap(m -> m, m ->
// m.getAnnotation(TrackExecutionTime.class)));
//
//             if(beanInterface.length > 0){
//                 ExecutionTimeInvocationHandler invocationHandler = new
// ExecutionTimeInvocationHandler(bean,mapAnnotation);
//                 return Proxy.newProxyInstance(beanClass.getClassLoader(), beanInterface,
// invocationHandler);
//             }else {
